public class LRUCache{
    ...
    public void put(int id, String data){
        ...
        // the date is not present in the cache so insert
    ...
    private void add(Node node){
        ...
        // if there is 1 node in the list: it is the head and the tail as well
    ...
    private void removeTail(){
        ...
        // new tail node is the previous node (because we remove the actual node)
    ...
    private void update(Node node){
        ...
        // so it is the middle node in a linked list
        ...
        if(nextNode != null){
            ...
            // we know that it is that last node
